...
#### In our four California regions, we see a positive association between average housing prices and avocado prices. The housing dataset was created using median housing prices from Zillow. This suggests that where housing prices are higher, avocado costs reflect the overall cost of living in each region. In essence, millennials are probably not living in San Francisco where both the housing and avocado prices are unfortunate.
